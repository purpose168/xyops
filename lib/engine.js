// OpsRocket Server Engine Component
...
class OpsRocket extends Component {
	...
	startup(callback) {
		// start app service
		var self = this;
		this.logDebug(3, "OpsRocket engine starting up", process.argv );
	...
	finishStartup(callback) {
		...
		this.request = new PixlRequest( "OpsRocket v" + this.server.__version );
	...
	shutdown(callback) {
		...
		var self = this;
		this.shut = true;
		this.logDebug(2, "Shutting down OpsRocket");
		this.multiShutdown();
		this.maintShutdown();
