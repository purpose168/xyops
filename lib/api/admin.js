				...
				function() {
					...
					async.eachSeries( self.config.getPath('ui.globalMemoryLists'),
						...
						function() {
							...
							// summary
							job.details += "\n#### Details\n\n";
							job.details += "- **DB Records Deleted:** " + Tools.commify(stats.records) + "\n";
							job.details += "- **Storage Lists Deleted:** " + Tools.commify(stats.lists) + "\n";
							job.details += "- **Storage Keys Deleted:** " + Tools.commify(stats.keys) + "\n";
